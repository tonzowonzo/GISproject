...
# Compile the model
model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=[metrics.hinge, 'accuracy', metrics.kullback_leibler_divergence])
...
training_set = train_datagen.flow_from_directory(r'temporal_stacks/train',
                                                 target_size = (299, 299),
                                                 batch_size = 128,
                                                 class_mode = 'categorical')

test_set = test_datagen.flow_from_directory(r'temporal_stacks/test',
                                            target_size = (299, 299),
                                            batch_size = 128,
                                            class_mode = 'categorical')
